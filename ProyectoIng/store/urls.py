...
from .views import CreateStore, UserStores, StoreDetailView, StoreUpdate, StoreDelete, CreateAdStore, CreateAdStore2, update_store
...
urlpatterns = [
    ...
    path('store/createAd', CreateAdStore2.as_view(), name="ad_create_store"),
